...
class Transformer(nn.Module):
    def __init__(self, input_size, output_size,hidden_size, num_heads,num_layers,dim_feedforward,dropout=0.2):
        super().__init__()
    ...
    def forward(self, x):
        ...
        x = self.transformer_encoder(x, mask=future_mask, src_key_padding_mask=padding_mask)
        x = self.outlayer(x)
